function UIElement()
    ...
    UIFramework.webui:Subscribe("OnUIFrameworkEvent", function(objectId, eventType)
    ...
    UIFramework.webui:Subscribe("OnUIFrameworkEvent", function(objectId, eventType, valueType, value)
    ...
    UIFramework.webui:Subscribe("OnUIFrameworkEvent", function(objectId, eventType, valueType, value)
        --print("OnUIFrameworkEvent", objectId)
        if self ~= nil and tonumber(objectId) == tonumber(self.options.id) and eventType == "change" then

            if valueType == "array" then
                --print(value)
                --print("Parse", valueType, NanosUtils.Dump(JSON.parse(value)))
                self.options.value = JSON.parse(value)
    ...
    function self.getObjectAsJSON()
        return JSON.stringify(self.options)
    end
...
Package.Export("UIElement", UIElement)